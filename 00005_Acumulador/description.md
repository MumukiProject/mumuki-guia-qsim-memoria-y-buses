Esta vez, vamos a usar el registro `R2` como **acumulador**: iremos sumando en él múltiples valores, en este caso los de algunas direcciones de memoria. :crystal_ball:
